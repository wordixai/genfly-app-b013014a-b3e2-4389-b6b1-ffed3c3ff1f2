          ...
          <div className="flex flex-row gap-2 max-w-56">
            ...
            <div className="w-10 h-10 bg-muted rounded-lg flex items-center justify-center">
              <svg viewBox="0 0 24 24" className="w-5 h-5" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="m4.8 3.54 6.05 4.6-1.24-2.98L4.8 3.54ZM16.83 15.9l-1.78 3.08 3.8 1.18 1.07-4.22-3.1-.05Zm-12.74.04 1.07 4.22 3.8-1.18-1.79-3.09-3.08.05Z" fill="#E27625"></path>
              </svg>
            </div>
            <div className="w-10 h-10 bg-muted rounded-lg flex items-center justify-center">
